...
```{r}
fileNames <- c("ELISA_data/091918 IL10 ELISA Plate1.xlsx","ELISA_data/091918 IL10 ELISA Plate2.xlsx", "ELISA_data/092518 IFNg ELISA Plate1.xlsx", "ELISA_data/092518 IFNg ELISA Plate2.xlsx")
...
labels(dend) <- paste(as.character(combinedData$sampleName)[order.dendrogram(dend)], sep = "")
